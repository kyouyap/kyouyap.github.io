...
const Contact: React.FC = () => (
  <section className="relative flex flex-col items-center justify-center text-center py-20 bg-gradient-to-br from-orange-100 via-pink-50 via-purple-50 to-blue-100 rounded-3xl overflow-hidden">
    ...
    <div className="relative z-10 max-w-2xl mx-auto px-8">
      <h1 className="text-4xl md:text-6xl font-extrabold mb-8 text-transparent bg-clip-text bg-gradient-to-r from-orange-600 via-pink-600 to-purple-600">
        📧 Contact Me
      </h1>
      ...
      <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-8 border border-white/40 mb-8">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          ...
          <a
            ...
            className="flex items-center px-6 py-4 bg-gradient-to-r from-purple-500 to-pink-500 text-white font-bold rounded-full transform hover:scale-105 transition-all duration-300"
          >
